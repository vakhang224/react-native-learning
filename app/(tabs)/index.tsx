  ...
  return (
    <View className="flex-1 bg-primary ">
      ...
      <ScrollView className="flex-1 px-5 " 
        ...
        <Text className="text-white">Error: {moviesError?.message || tredingError?.message}</Text>
      ): (
        <View className="flex-1 mt-5">
            ...
            <>
              <Text className="text-lg text-white mt-5">Latest Movies</Text>
